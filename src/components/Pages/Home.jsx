  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-8 p-5 text-center scroll-mt-20 md:scroll-mt-0">
        <div className="box overflow-visible m-4 border-1 border-transparent p-0 z-20">
          <img
            src={Artwork}
            alt="Logo"
            className="w-[250px] sm:w-[300px] rounded-full scroll-mt-14 md:scroll-mt-0 overflow-hidden"
          />
        </div>
